...
type UserServiceClient interface {
	...
	GetUserID(ctx context.Context, in *GetUserId, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) GetUserID(ctx context.Context, in *GetUserId, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	GetUserID(context.Context, *GetUserId) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) GetUserID(context.Context, *GetUserId) (*UserResponse, error) {
...
func _UserService_GetUserID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserID(ctx, req.(*GetUserId))
	}
	return interceptor(ctx, in, info, handler)
}
